                            ...
                            query.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if(existUser) {
                                        ...
                                        //
                                        DataManager.getInstance().setUid(loadUid);
                                        DataManager.getInstance().setNickname(loadNickname);
                                        DataManager.getInstance().setLocation(loadLocation);
                                        DataManager.getInstance().setAge(loadAge);
                                        DataManager.getInstance().setGender(loadGender);
                                        DataManager.getInstance().setDeviceToken(loadDevToken);
...
//                                        intent.putExtra("prof", profExtra);
                                        ...
                                        DataManager.getInstance().setUid(uidExtra);
                                        DataManager.getInstance().setDeviceToken(devTokenExtra);
                                        intent.putExtra("preAct", "StartLogin");
