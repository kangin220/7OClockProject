...
//        fUser = FirebaseAuth.getInstance().getCurrentUser();
        initViews(DataManager.getInstance().getNickname());
        createChannel(DataManager.getInstance().getUid(), friendProf.getUid());
        initFirebaseDatabase();
//        initValues();
        userName = DataManager.getInstance().getNickname();
    }
