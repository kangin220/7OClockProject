...
public class BoardDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    ImageButton replyWriteBtn;
    ImageButton boardDeleteBtn;
    ImageButton likeBtn ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //자신의 글일때만 삭제버튼보임
        if(board.getWriter().equals(DataManager.getInstance().getNickname()))
        ...
        replyListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(DataManager.getInstance().getNickname().equals(curItem.getWriter()))
                {
                ...
                {
                    Toast.makeText(BoardDetailActivity.this,DataManager.getInstance().getNickname()+"은 "+board.getWriter()+"의 댓글을 삭제할 수 없습니다.",Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void writeReply()
    {
        ...
        builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                //여기서 push함
                ReplyDTO replyExample= new ReplyDTO(MyUtil.getDate(),writeReplyDialog_editText.getText().toString().trim(),DataManager.getInstance().getNickname());
    ...
    {
        if(DataManager.getInstance().getNickname().equals(board.getWriter()))
        {
            AlertDialog.Builder builder = new AlertDialog.Builder(BoardDetailActivity.this);
            //옵션 설정
        ...
        {
            Toast.makeText(BoardDetailActivity.this,DataManager.getInstance().getNickname()+"은 "+board.getWriter()+"의 글을 삭제할 수 없습니다.",Toast.LENGTH_LONG).show();
        }
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            ...
            case R.id.board_detail_likeBtn: //추천버튼
                ...
                {
                    if(likeList.get(i).getuId().equals(DataManager.getInstance().getNickname()))
                    {
                ...
                if(!flag)
                {
                    ...
                    LikeDTO likeData= new LikeDTO(DataManager.getInstance().getNickname());
