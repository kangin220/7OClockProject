...
import com.bicyle.bicycle.ClubActivity;
...
//        myProf = (ProfDataSet) intent.getSerializableExtra("prof");
        ...
        final ArrayAdapter<String> adapter = new ArrayAdapter<>(this, R.layout.navi_listview, mainFuncList);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId())
        {
            ...
            case R.id.board_myBoardBtn :
                ...
                for(BoardDTO board : boardList)
                {
                    if(board.getWriter().contains(DataManager.getInstance().getNickname())) //userName과 일치하는 board
                    {
                        searchBoardList.add(board);
                    }
                }
            ...
            case R.id.board_writeBtn :
                ...
                builder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        //여기서 push함
                        BoardDTO boardExample = new BoardDTO(titleET.getText().toString(),DataManager.getInstance().getNickname(), writeBoardKind,
